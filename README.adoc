...
This training is based on the link:https://jakarta.ee/release/9/[Jakarta-EE 9.1] link:https://projects.eclipse.org/projects/technology.microprofile/releases/microprofile-4.1[(Eclipse MicroProfile 4.1)] specification and the link:https://www.wildfly.org/[Wildfly 26.1.0.Final] application server.
